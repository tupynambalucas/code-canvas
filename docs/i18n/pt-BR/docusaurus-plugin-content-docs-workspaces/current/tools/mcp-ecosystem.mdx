...
O monorepo CodeCanvas apresenta um ecossistema MCP especializado e conteinerizado. Ele expõe capacidades de desenvolvimento estruturadas e contextos da base de código para clientes LLM (como o Antigravity CLI ou agentes externos) por meio de uma rede de gateway segura e de alto desempenho.
...
- **Upstream:** `http://codecanvas-mcp-github:3001/github/sse`
...
- **Upstream:** `http://codecanvas-mcp-context7:3002/context7/sse`
...
- `browser_close`: fechar a janela do navegador.
...
- **Upstream:** `http://codecanvas-mcp-dockerhub:3004/dockerhub/sse`
