...
Este documento define as convenções estritas de codificação e requisitos de qualidade para o projeto **CodeCanvas**. Todo o código deve aderir a estes padrões para garantir consistência e manutenibilidade em todo o monorepo.
...
### 4.1. Pacotes Core (`@codecanvas/extension` / `@codecanvas/extension`)
