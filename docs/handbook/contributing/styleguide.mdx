...
This document defines the strict coding conventions and quality requirements for the **CodeCanvas** project. All code must adhere to these standards to ensure consistency and maintainability across the monorepo.
...
### 4.1. Core Packages (`@codecanvas/extension` / `@codecanvas/extension`)
