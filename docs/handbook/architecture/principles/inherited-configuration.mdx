...
description: Tooling governance and root-level config inheritance across the CodeCanvas monorepo.
---
...
In CodeCanvas, all toolings and configurations are centrally orchestrated from the root:
