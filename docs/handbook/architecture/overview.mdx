...
The Elo Orgânico codebase is organized into **Domain Contexts** at the root level. For a detailed breakdown of the application roles, context philosophy, and directory structures, please refer to the dedicated Bounded Context documentation.
